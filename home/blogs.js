...
gsap.set(".stacklyBlogTag", {
  y: 30,
  opacity: 0,
});
gsap.set(".stacklyBlogTitle", {
  y: 40,
  opacity: 0,
});
gsap.set(".stacklyBlogDesc", {
  y: 30,
  opacity: 0,
});
gsap.set(".stacklyBlogCard", {
  y: 80,
  opacity: 0,
});
...
function startHeroAnim() {
  ...
  gsap.to(".stacklyBlogTag", {
    y: 0,
    opacity: 1,
    duration: 1,
    scrollTrigger: {
      trigger: ".stacklyBlogSection",
      start: "top 85%",
    },
  });

  gsap.to(".stacklyBlogTitle", {
    y: 0,
    opacity: 1,
    duration: 1,
    delay: 0.2,
