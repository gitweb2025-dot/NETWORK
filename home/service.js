...
gsap.set(".stacklyServicesTag", {
  y: 30,
  opacity: 0,
});
gsap.set(".stacklyServicesTitle", {
  y: 40,
  opacity: 0,
});
gsap.set(".stacklyServicesDesc", {
  y: 30,
  opacity: 0,
});
gsap.set(".stacklyServiceCard", {
  y: 80,
  opacity: 0,
});
...
function startHeroAnim() {
  ...
  gsap.to(".stacklyServicesTag", {
    y: 0,
    opacity: 1,
    duration: 1,
    scrollTrigger: {
      trigger: ".stacklyServicesSection",
      start: "top 85%",
    },
  });

  gsap.to(".stacklyServicesTitle", {
    y: 0,
    opacity: 1,
    duration: 1,
    delay: 0.2,
...
// STATS
gsap.from(".stacklyPromoTag", {
  y: 30,
  opacity: 0,
  duration: 1,
  scrollTrigger: {
    trigger: ".stacklyPromoSection",
    start: "top 85%",
  },
});

gsap.from(".stacklyPromoTitle", {
  y: 40,
  opacity: 0,
  duration: 1,
  delay: 0.2,
...
gsap.from(".stacklyPromoStats", {
  y: 80,
  opacity: 0,
  duration: 1.2,
  ease: "power3.out",
  scrollTrigger: {
    trigger: ".stacklyPromoStats",
    start: "top 90%",
  },
});

const counters = document.querySelectorAll(".stacklyCounter");
