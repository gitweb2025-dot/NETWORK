...
gsap.set(".stacklyWhyBetterImageWrap", {
  x: -80,
  opacity: 0,
});
gsap.set(".stacklyWhyBetterTag", {
  y: 20,
  opacity: 0,
});
gsap.set(".stacklyWhyBetterTitle", {
  y: 40,
  opacity: 0,
});
gsap.set(".stacklyWhyBetterDesc", {
  y: 30,
  opacity: 0,
});
gsap.set(".stacklyWhyBetterItem", {
  x: 60,
  opacity: 0,
});
gsap.set(".stacklyRatingBadge", {
  y: 40,
  opacity: 0,
});
...
function startHeroAnim() {
  ...
  gsap.to(".stacklyWhyBetterImageWrap", {
    x: 0,
    opacity: 1,
    duration: 1.2,
    ease: "power3.out",
    scrollTrigger: {
      trigger: ".stacklyWhyBetterSection",
      start: "top 85%",
    },
  });

  gsap.to(".stacklyWhyBetterTag", {
    y: 0,
    opacity: 1,
    duration: 1,
    scrollTrigger: {
  ...
  gsap.to(".stacklyWhyBetterItem", {
    ...
    ease: "power3.out",
    scrollTrigger: {
      trigger: ".stacklyWhyBetterFeatures",
      start: "top 85%",
    },
  });

  gsap.to(".stacklyRatingBadge", {
    y: 0,
    opacity: 1,
    duration: 1,
    delay: 0.4,
    scrollTrigger: {
      trigger: ".stacklyWhyBetterImageWrap",
      start: "top 85%",
    },
  });
}
