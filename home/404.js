...
gsap.set(".stackly404Icon", {
  scale: 0,
  opacity: 0,
  duration: 1,
});
gsap.set(".stackly404Title", {
  y: 50,
  opacity: 0,
});
gsap.set(".stackly404Heading", {
  y: 40,
  opacity: 0,
});
gsap.set(".stackly404Desc", {
  y: 40,
  opacity: 0,
});
gsap.set(".stackly404Buttons", {
  y: 40,
  opacity: 0,
});
