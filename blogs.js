...
gsap.set(".stacklyBlogHeroTitle", {
  y: 60,
  opacity: 0,
});
gsap.set(".stacklyBlogHeroSubtitle", {
  y: 40,
  opacity: 0,
});
gsap.set(".stacklyBlogHeroImage", {
  scale: 0.85,
  opacity: 0,
});
...
function startHeroAnim() {
  ...
  gsap.to(".stacklyBlogHeroTitle", {
    ...
    scrollTrigger: {
      trigger: ".stacklyBlogHeroSection",
      start: "top 85%",
    },
  });

  gsap.to(".stacklyBlogHeroSubtitle", {
    y: 0,
    opacity: 1,
    duration: 1,
    delay: 0.2,
  ...
  gsap.to(".stacklyBlogHeroImage", {
    ...
    scrollTrigger: {
      trigger: ".stacklyBlogHeroImageWrapper",
      start: "top 85%",
    },
  });
}
...
gsap.from(".stacklyRecentPosts", {
  y: 40,
  opacity: 0,
  duration: 1,
  scrollTrigger: {
    trigger: ".stacklySidebar",
    start: "top 85%",
  },
});

gsap.from(".stacklyCategories", {
  y: 40,
  opacity: 0,
  duration: 1,
  delay: 0.2,
...
gsap.from(".stacklyBlogCard", {
  y: 60,
  opacity: 0,
  duration: 1,
  stagger: 0.2,
  scrollTrigger: {
    trigger: ".stacklyBlogContent",
    start: "top 85%",
  },
});
