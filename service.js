...
gsap.set(".stacklyExperienceTitle", {
  y: 60,
  opacity: 0,
});
gsap.set(".stacklyExperienceSubtitle", {
  y: 40,
  opacity: 0,
});
gsap.set(".stacklyImg", {
...
function startHeroAnim() {
  ...
  gsap.to(".stacklyExperienceTitle", {
    y: 0,
    opacity: 1,
    duration: 1,
    ease: "power3.out",
    ...
    scrollTrigger: {
      trigger: ".stacklyExperienceSection",
      start: "top 80%",
    },
  });

  gsap.to(".stacklyExperienceSubtitle", {
    y: 0,
    opacity: 1,
    duration: 1.3,
    delay: 0.3,
  ...
  gsap.to(".stacklyImg", {
    ...
    scrollTrigger: {
      trigger: ".stacklyExperienceImageWrapper",
      start: "top 85%",
    },
  });
}
...
gsap.from(".stacklyServiceCard", {
  ...
  scrollTrigger: {
    trigger: ".stacklyServicesWrapper",
    start: "top 85%",
  },
});

// APP
gsap.from(".stacklyAppTitle", {
  y: 50,
  opacity: 0,
  duration: 1,
  ease: "power3.out",
  ...
  scrollTrigger: {
    trigger: ".stacklyAppSection",
    start: "top 80%",
  },
});

gsap.from(".stacklyAppSubtitle", {
  y: 40,
  opacity: 0,
  duration: 1,
  delay: 0.2,
...
gsap.from(".stacklyFeatureItem", {
  ...
  scrollTrigger: {
    trigger: ".stacklyAppFeatures",
    start: "top 85%",
  },
});

gsap.from(".stacklyAppImage", {
  x: 80,
  opacity: 0,
  duration: 1.2,
  ease: "power3.out",
