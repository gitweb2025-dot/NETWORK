...
gsap.set(".stacklyCtaTitle", {
  y: 50,
  opacity: 0,
});
gsap.set(".stacklyCtaBtn", {
  y: 50,
  opacity: 0,
});
gsap.set(".stacklyImg", {
...
//PLANS
gsap.from(".stacklyPlanTitle", {
  y: 50,
  opacity: 0,
  duration: 1,
  ease: "power3.out",
  scrollTrigger: {
    trigger: ".stacklyPlanTitle",
    start: "top 85%",
  },
});

gsap.from(".stacklyPlanSubtitle", {
  y: 30,
  opacity: 0,
  duration: 1,
  delay: 0.2,
  ease: "power3.out",
  scrollTrigger: {
    trigger: ".stacklyPlanSubtitle",
    start: "top 85%",
  },
});

gsap.from(".stacklyWifiCard", {
  y: 60,
  opacity: 0,
  duration: 1,
  stagger: 0.2,
  ...
  scrollTrigger: {
    trigger: ".stacklyWifiPlansWrapper",
    start: "top 85%",
  },
});
