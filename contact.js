...
gsap.set(".stacklyContactHeader", {
  y: 50,
  opacity: 0,
});
gsap.set(".stacklyContactItem", {
  y: 40,
  opacity: 0,
});
gsap.set(".stacklyContactTrust", {
  y: 30,
  opacity: 0,
});
...
function startHeroAnim() {
  ...
  gsap.to(".stacklyContactItem", {
    y: 0,
    opacity: 1,
    duration: 1,
    stagger: 0.2,
    scrollTrigger: {
      trigger: ".stacklyContactGrid",
      start: "top 85%",
    },
  });

  gsap.to(".stacklyContactTrust", {
    y: 0,
    opacity: 1,
    duration: 1,
    delay: 0.3,
    scrollTrigger: {
      trigger: ".stacklyContactTrust",
      start: "top 90%",
    },
  });
}
